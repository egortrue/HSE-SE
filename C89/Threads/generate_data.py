...
def handle_args():
    ...
    parser.add_argument('particles_count', action='store', type=int, help='Number of particles')
    parser.add_argument('steps', action='store', type=int, help='Number of steps')
    parser.add_argument('filename', action='store', type=str, help='Destination of generation')
